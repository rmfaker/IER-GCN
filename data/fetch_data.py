...
root_folder = '/home/zhangpeng/CTS/EV_GCN/data'
...
time_series = Reader.get_timeseries(subject_IDs, 'cc200')

# Compute and save connectivity matrices
for i in range(len(subject_IDs)):
        Reader.subject_connectivity(time_series[i], subject_IDs[i], 'cc200', 'correlation')
